...
namespace reflect {
    ...
    std::unique_ptr<Enum<Calyx::Enum>> Enum<Calyx::Enum>::s_instance = std::make_unique<Enum<Calyx::Enum>>();
    
    std::unordered_map<std::string, int> Enum<Calyx::Enum>::s_enumValues = { 
        { "ENUM1", 0 },
        { "ENUM2", 1 },
        { "ENUM3", 2 },
        { "ENUM4", 3 },
    ...
    std::vector<std::string> Enum<Calyx::Enum>::GetStringValues() const {
        return { 
            "ENUM1",
            "ENUM2",
            "ENUM3",
    ...
    std::vector<int> Enum<Calyx::Enum>::GetIntValues() const {
        return { 
            0,
            1,
            2,
    ...
    bool Enum<Calyx::Enum>::Translate(const std::string& value, int& out) const {
    ...
    bool Enum<Calyx::Enum>::Translate(int value, std::string& out) const {
       for (auto& it : s_enumValues) {
            if (it.second == value) {
                out = it.first;
                return true;
